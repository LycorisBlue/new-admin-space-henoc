            ...
            <div className="bg-white rounded-xl border border-gray-200">
                ...
                <div className="p-6">
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-500">Tableau des factures à implémenter</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <div>
                            ...
                            <ul className="text-sm text-gray-600 space-y-2">
                                <li>• Filtrez par statut ou paiement</li>
                                <li>• Triez via les en-têtes</li>
                                <li>• Cliquez "Détails" pour consulter</li>
                                <li>• Cliquez "Payer" pour régler</li>
                                <li>• Créez via les demandes clients</li>
                            </ul>
                        </div>
                        <div>
