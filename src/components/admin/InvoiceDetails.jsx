                ...
                <div className="p-6">
                    <div className="flex items-start justify-between mb-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            {invoice.status !== 'annulé' && invoice.payment_info.payment_status !== 'paid' && !fullyPaid && (
                                <Link
                                    href={`/dashboard/invoices/${invoice.id}/payment`}
                                    className="inline-flex items-center gap-2 px-3 py-1 text-sm bg-gray-900 text-white rounded-full hover:bg-gray-800 transition-colors"
                                >
